            ...
            <div ref={searchRef} className="flex-1 min-w-0 max-w-2xl relative">
              <div className="flex w-full relative">
                <input 
                  ...
                  className={`w-full bg-slate-100/80 md:bg-slate-50 text-slate-800 text-sm rounded-full pl-5 pr-14 outline-none border border-slate-200 focus:border-[#1C2978] focus:ring-2 focus:ring-[#1C2978]/20 focus:bg-white transition-all shadow-inner ${isScrolled ? 'py-1.5 md:py-2' : 'py-2.5 md:py-3'}`}
                />
                      ...
                      {hoveredCategory === cat.slug && (
                        ...
                        >
                          ...
                          <div className="mt-2 px-3">
                            <button
                              onClick={() => handleNavClick({ preventDefault: () => {} } as any, cat.slug)}
